...
The recall, precision and F1 tables this section refers to are in \S4.16, which reports the headline comparison: the model recovers 0.40 of the human triplets against the pipeline's 0.83, and is the more precise labeller on the judged pairs, 0.42 against 0.35, while losing F1 on every predicate.

...
The source paper's motivating example, an LLM planner that fails to remove a cube before grasping the book beneath it until spatial relations are supplied, is asserted on one scene. This section runs it as an experiment.

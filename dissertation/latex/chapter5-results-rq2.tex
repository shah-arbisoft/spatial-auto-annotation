...
\textbf{The threshold refit of \S{}4.14 cost condition C three scenes, and E none.} An earlier version of this experiment ran on the labels \texttt{on\_\allowbreak{}contact\_\allowbreak{}min} 0.60 produced and recorded C at 22 of 25. The shipped rule is 0.85, which emits support more sparingly: across the same 25 scenes the support relation the task depends on is now present in 18 rather than 22, absent in scenes 1, 4, 7, 16, 19, 24 and 25 where before it was absent in 4, 16 and 24 alone. Re-run on the shipped labels, \textbf{C scores 19 of 25 on both planners} and E still scores 25 of 25, with 6 scenes gained over C and none lost.

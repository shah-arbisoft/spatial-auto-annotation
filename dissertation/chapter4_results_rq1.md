...
Precision on the labels the tool adds beyond that record went through three
instruments of increasing severity, an author audit, then a blind
decoy-controlled re-audit with a second judge, then a volunteer study, and
all three agree on where it holds and where it does not. Every remaining

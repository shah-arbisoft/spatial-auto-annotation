...
**What is anonymised, and what is not.** Five things are easily run
...
4. *The validation website.* The same masking, applied before publication,
   with `noindex` set on the site.
5. *Published figures.* One figure in this dissertation shows scene imagery,

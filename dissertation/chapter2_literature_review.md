...
literature that frames its validation (§2.6). Section 2.7 then states the
research gap in the form of a critical comparison.
...
## 2.7 Critical comparison and the research gap

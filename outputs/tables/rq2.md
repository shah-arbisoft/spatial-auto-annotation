...
|---|---|---|---|---|
| on | 0.84 (0.83-0.86) | 0.90 (0.89-0.92) | 0.88 (0.87-0.89) | 348 |
| under | 0.44 (0.36-0.53) | 0.59 (0.59-0.60) | 0.85 (0.85-0.85) | 192 |
...
| behind | 0.15 (0.12-0.17) | 0.22 (0.17-0.28) | 0.37 (0.37-0.37) | 580 |
...
| auto-trained | 0.748 | 0.157 | 0.210 | 0.188 | 0.661 | 0.034 | 0.064 |

Per predicate, average precision (threshold-free):

| predicate | human-trained | pseudo-labelled | auto-trained |
|---|---|---|---|
| on | 0.790 | 0.689 | 0.692 |
| under | 0.246 | 0.247 | 0.487 |
| to the left of | 0.156 | 0.144 | 0.040 |
| to the right of | 0.254 | 0.261 | 0.046 |
| in front of | 0.052 | 0.052 | 0.019 |
| behind | 0.085 | 0.095 | 0.021 |
| near | 0.029 | 0.019 | 0.009 |
| **mean** | **0.30** | **0.36** | **0.75** | |